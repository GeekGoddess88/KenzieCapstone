...
public class IngredientController {
    ...
    @PutMapping("/{id}")
    public CompletableFuture<ResponseEntity<IngredientResponse>> updateIngredient(@PathVariable("id") String id, @RequestBody IngredientUpdateRequest ingredientUpdateRequest) {
    ...
    @DeleteMapping("/{id}")
    public CompletableFuture<ResponseEntity<DeleteIngredientResponse>> deleteIngredient(@PathVariable("id") String id) {
