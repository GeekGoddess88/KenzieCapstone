...
public class DrinkRecord {
    ...
    public List<IngredientRecord> getIngredients() { return ingredients;}
    public void setIngredients(List<IngredientRecord> ingredients) { this.ingredients = ingredients; }
